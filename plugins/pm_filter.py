...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("Search Your Own File, Don't Click Others Results 😬", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('MAIN CHANNEL', url='https://t.me/+MQr7_5zLE1k1MTk1'),
            InlineKeyboardButton('MOVIE GROUP', url='https://t.me/+tSSlF2nKDbo5MWJl')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"Rᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ : <code>{search}</code>\n\n\n😌 <b>IF THE MOVIE YOU ARE LOOKING FOR IS NOT COMING THEN</b> 😌 \n\n<b>FOLLOW THESE STEPS 👇</b> \n\n(1) Search That Movie On Google \n(2) Copy The Correct Spelling \n(3) Send Me That Correct Spelling"
